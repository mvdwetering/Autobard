...
dl[756] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_MISTS, heroic = ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA }   -- The Deadmines
dl[764] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_MISTS, heroic = ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA }   -- Shadowfang Keep
dl[753] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_MISTS, heroic = ATBD_REPGROUP_CATA }  -- Blackrock Caverns
dl[767] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_MISTS, heroic = ATBD_REPGROUP_CATA }  -- Throne of Tides
dl[768] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_MISTS, heroic = ATBD_REPGROUP_CATA }  -- Stonecore
dl[769] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_MISTS, heroic = ATBD_REPGROUP_CATA }  -- Vortex Pinnacle
dl[759] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA + ATBD_REPGROUP_MISTS }          -- GrimBatol
dl[759] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA + ATBD_REPGROUP_MISTS }          -- Halls of Origination
dl[747] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA + ATBD_REPGROUP_MISTS }          -- Lost City of Tol'vir

-- *** Patch 4.1 dungeons ***
dl[793] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY  + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA + ATBD_REPGROUP_MISTS }          -- Zul'Gurub
dl[781] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY  + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA + ATBD_REPGROUP_MISTS }          -- Zul'Aman

-- *** Patch 4.3 dungeons ***
dl[820] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY  + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA + ATBD_REPGROUP_MISTS }          -- End Time
dl[816] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY  + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA + ATBD_REPGROUP_MISTS }          -- Well of Eternity
dl[819] = { xpack = ATBD_EXP_CATA, normal = ATBD_REPGROUP_CITY  + ATBD_REPGROUP_WOTLK + ATBD_REPGROUP_CATA + ATBD_REPGROUP_MISTS }          -- Hour of Twilight
